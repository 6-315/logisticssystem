...
public class vehicle {
	...
	public String toString() {
		return "vehicle [vehicle_id=" + vehicle_id + ", vehicle_num=" + vehicle_num + ", vehicle_platenum="
				+ vehicle_platenum + ", vehicle_standard=" + vehicle_standard + ", vehicle_state=" + vehicle_state
				+ ", vehicle_distribution_state=" + vehicle_distribution_state + ", vehicle_express_state="
				+ vehicle_express_state + ", vehicle_drivingdirection=" + vehicle_drivingdirection + ", vehicle_unit="
				+ vehicle_unit + ", vehicle_acquisitiontime=" + vehicle_acquisitiontime + ", vehicle_acquisitionpeople="
