...
public class express_route {
	...
	public String toString() {
		return "express_route [express_route_id=" + express_route_id + ", express_route_belongexpress="
				+ express_route_belongexpress + ", eexpress_route_state=" + eexpress_route_state
				+ ", express_route_superior=" + express_route_superior + ", express_route_createtime="
				+ express_route_createtime + ", express_route_modifytime=" + express_route_modifytime + "]";
	}
