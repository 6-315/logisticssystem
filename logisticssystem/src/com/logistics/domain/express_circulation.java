...
public String toString() {
	return "express_circulation [express_circulation_id=" + express_circulation_id + ", express_circulation_express_id="
			+ express_circulation_express_id + ", express_circulation_launchpeople=" + express_circulation_launchpeople
