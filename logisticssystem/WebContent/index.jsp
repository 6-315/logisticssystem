        ...
        <div class="row" id="reservation_express">
                ...
                <div class="yto-item">
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">地址</label> <input
                            name="sendAddress" v-model="view_express.expressinfo_senderdetailaddress"
            ...
            <div class="col-sm-4">
                <div class="yto-item">
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">真实姓名</label> <input
                            name="receiveName" v-model="view_express.expressinfo_addresseerealname"
                            class="form-control" placeholder="请输入姓名"
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">省/市/区</label>
                        <div class="dropdown yto-city">
                            <input id="receiveRegion" v-model="view_express.expressinfo_addresseeaddress"
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">地址</label> <input
                            name="receiveAddress" v-model="view_express.expressinfo_adderdetailaddress"
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">手机</label> <input
                            name="receiveMobile" v-model="view_express.expressinfo_addresseephonenumber"
                            class="form-control"
                ...
                <div class="yto-item" style="min-height: 460px">
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">特殊备注</label> <input name="remark"
                                                                         ...
                                                                         v-model="view_express.expressinfo_mark"
                                                                         maxlength="100"
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">内件品名</label> <input required="true"
                                                                         ...
                                                                         id="productName"
                                                                         v-model="view_express.expressinfo_productname"
                    ...
                    <div class="form-group form-material">
                        <label class="control-label">物品重量（kg）</label> <input id="weight"
                                                                             ...
                                                                             v-model="view_express.expressinfo_productweight"
            ...
            <div class="col-sm-4 col-md-offset-4 p_bottom_10"
                 style="margin: auto">
                <input :disabled="disabled" v-on:click="addReservation" value="提交预约单" id="saveBtn"
