											...
											<tr>
												...
												<th><span role="presentation" class="dropdown">
														...
														<ul class="dropdown-menu">
															<li><a @click="selectUnitType('')" href="#">单位类型(所有)</a></li>
												...
												<th><span role="presentation" class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li><a @click="selectUnitState('正常使用')" href="#">正常使用</a></li>
										...
										<tbody style="min-height: 200px">
											<tr
												...
												<td>{{unitManagerDTO.unit_Admin !=
													undefined?unitManagerDTO.unit_Admin.staff_num:''}}</td>
												<td>
												...
												<td><a href="#"><i class="fa fa-pencil-square-o"
														...
														class="fa fa-plus-circle" aria-hidden="true"></i></a></td>
											</tr>
										</tbody>
									</table>
