							...
							<div class="col-md-6">
								<div class="form-group">
									<label>单位名称</label> <input id="shuju" type="hidden"
										...
										class="form-control" v-model="transferStation.unit_name"
										placeholder="请输入名称..">
								</div>
								<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>单位类型</label> <select @change="getAdmin"
										...
										<option v-if="myRole==6" value="中转站">中转站</option>
										<option v-if="myRole==6 || myRole==5" value="配送点">配送点</option>
									</select>
								</div>
							</div>
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>状态</label> <select class="form-control"
										v-model="transferStation.unit_state" data-placeholder="单位状态"
										style="width: 100%;">
										<option>未启用</option>
										<option>正常使用</option>
										<option>已废弃</option>
							...
							<div class="col-md-6">
								<div class="form-group">
									<button @click="addUnit" type="button"
										...
										class="btn btn-block btn-primary">提交</button>
								</div>
							</div>
						</div>
					</div>
