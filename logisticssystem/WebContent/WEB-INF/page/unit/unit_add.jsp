                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/test/test/pages/unit/unit_add.html" class="nav-link active">
                                    <i class="fa fa-plus-square-o nav-icon"></i>
                                    <p>增加单位</p>
                                </a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="express_mark">单位名称</label>
                                    <input type="text" class="form-control" id="express_mark" placeholder="请输入单位名称..">
                                </div>
                                <div class="form-group">
                                    <label>创建人</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <br>
                                        <label for="express_mark">单位详细地址</label>
                                        <input name="unit_detailaddress" type="text" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div data-toggle="city-picker">
                                            <input id="unit_address" name="unit_address" readonly type="text"
