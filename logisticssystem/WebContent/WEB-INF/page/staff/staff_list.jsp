                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/test/test/pages/staff/staff_list.html" class="nav-link active">
                                    <i class="fa fa-book nav-icon"></i>
                                    <p>员工查询</p>
                                </a>
                            </li>
                        ...
                        <div class="card-body">
                            <table id="example2" class="no-footer table table-bordered table-hover dataTable">
                                ...
                                <tr>
                                    ...
                                    <td>在职</td>
                                    <td>
                                        <a data-toggle="modal" data-target="#staffDetailInfo" href="">详细</a>|
                                        <a data-toggle="modal" data-target="#deleteStaffInfo" href="">删除</a>
                                    </td>
                                    <!-- <td>
