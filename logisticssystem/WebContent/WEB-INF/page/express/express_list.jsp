            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="no-footer table table-bordered table-hover dataTable">
                                <thead>
                                <tr>
                                    <th>单号</th>
                                    <th>内件品名</th>
                                ...
                                <tr>
                                    ...
                                    <td>已揽件</td>
                                    <td>
                                        <a data-toggle="modal" data-target="#mymodal" href="#">详细</a>|
                                        <a data-toggle="modal" data-target="#deleteModal" href="#">刪除</a>
                                    </td>
                                    <!-- <td>
