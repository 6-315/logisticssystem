...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/plugins/datarangepicker/datarangepicker-bs3.css">
<link rel="stylesheet"
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>内件品名</label> <select class="form-control select2"
										style="width: 100%;">
								...
								<!-- /.form-group -->
								<div class="form-group">
									<label for="express_weight">物品重量</label> <input type="email"
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>增值服务</label> <select class="form-control select2"
										multiple="multiple" data-placeholder="增值服务"
										style="width: 100%;">
										<option>保价</option>
										<option>使用</option>
									</select>
								...
								<div class="form-group">
									<label for="express_mark">备注</label> <input type="text"
										class="form-control" id="express_mark" placeholder="请输入备注..">
								</div>
								<!-- /.form-group -->
							</div>
							<!-- /.col -->
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="sender">真实姓名</label> <input type="text"
										class="form-control" id="sender" placeholder="请输入真实姓名..">
								</div>
								<div class="form-group">
									<label>地址</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="sender_address">详细</label> <input type="text"
										class="form-control" id="sender_address"
										placeholder="请输入详细地址..">
								</div>
								<!-- /.form-group -->
								<div class="form-group">
