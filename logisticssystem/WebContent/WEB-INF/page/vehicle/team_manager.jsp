						...
						<div class="card-body">
							...
							<div class="table-responsive" style="min-height: 300px">
								<table class="table table-hover">
									<thead>
										<tr>
											...
											<th>收件人联系方式</th>
											<th>收件人详细地址</th>
											<th v-if="myRole==5 || myRole==6"><span
											...
											<th v-if="myRole==5"><span role="presentation"
												class="dropdown"> <a class="dropdown-toggle"
													data-toggle="dropdown">是否分配配送点<span class="caret"></span></a>
													<ul class="dropdown-menu">
											...
											<th v-if="myRole==2"><span role="presentation"
												class="dropdown"> <a class="dropdown-toggle"
													data-toggle="dropdown">是否分配派送员<span class="caret"></span></a>
													<ul class="dropdown-menu">
												...
												role="presentation" class="dropdown"> <a
													...
													<ul class="dropdown-menu">
														...
														<li><a v-if="myRole==2 || myRole==5 || myRole==6"
															@click="selectState('待揽件')" href="#">待揽件</a></li>
														<li><a @click="selectState('已揽件')" href="#">已揽件</a></li>
														<li><a @click="selectState('待扫描')" href="#">待扫描</a></li>
														<li><a v-if="myRole==5 || myRole==6"
															@click="selectState('已扫描')" href="#">已扫描</a></li>
									...
									<tbody v-cloak
										...
										<tr
											...
											<td
												v-if="myRole==5 && expressInfoDTO.expressInfo.express_isdistributeddistribution">
												是</td>
											<td
												v-if="myRole==5 && !expressInfoDTO.expressInfo.express_isdistributeddistribution">
												否</td>
											<td
												v-if="myRole==2 && expressInfoDTO.expressInfo.express_isdistributeddistributor">
												是</td>
											<td
												v-if="myRole==2 && !expressInfoDTO.expressInfo.express_isdistributeddistributor">
												否</td>
											<td v-if="myRole==1 || myRole==2 || myRole==5 || myRole==6">
												{{expressInfoDTO.expressInfo.express_state}}</td>
											<td>
												<div class="btn-group">
								...
								<div style="float: right;">
									<a v-if="myRole==1" href="#" @click="expressQujian"
										class="btn btn-info">取件</a> <a v-if="myRole==3" href="#"
										@click="expressFaVehicle" class="btn btn-primary">发车</a> <a
										v-if="myRole==1 || myRole==3" href="#" @click="expressAddJ"
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" @click="saveExpressRoute"
								class="btn btn-danger">保存</button>
						</div>
					</div>
				</div>
			</div>
