            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/test/test/pages/vehicle/vehicle_list.html" class="nav-link active">
                                    <i class="fa fa-book nav-icon"></i>
                                    <p>????</p>
                                </a>
                            </li>
                        ...
                        <div class="card-body">
                            <table id="example2" class="no-footer table table-bordered table-hover dataTable">
                                ...
                                <tr>
                                    ...
                                    <td>???</td>
                                    <td>
                                        <a data-toggle="modal" data-target="#vehicleDetailInfo" href="">??</a>|
                                        <a data-toggle="modal" data-target="#deleteVehicleInfo" href="">??</a>
                                    </td>
                                    <!-- <td>
...
<!-- ./wrapper -->
<div class="modal fade" id="vehicleDetailInfo">
...
<div class="modal fade" id="deleteVehicleInfo">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- ??????? -->
            <div class="modal_header">
