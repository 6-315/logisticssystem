			...
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li v-if="myRole == 3 || myRole == 4 || myRole == 5 || myRole == 6"
					...
					<ul class="nav nav-treeview">
						...
						<li v-if="myRole == 5 || myRole == 3 || myRole == 4"
							class="nav-item"><a
						...
						<div class="card-body">
							...
							<div class="table-responsive" style="min-height: 300px">
								<table class="table table-hover">
									<thead>
										<tr>
											...
											<th>编号</th>
											<th>车牌号</th>
											<th v-if="myRole==6"><span role="presentation"
												class="dropdown"> <a class="dropdown-toggle"
													data-toggle="dropdown">单位(所有) <span class="caret"></span></a>
											...
											<th v-if="myRole != 6"><span role="presentation"
												class="dropdown"> <a class="dropdown-toggle"
													data-toggle="dropdown">车队(所有) <span class="caret"></span></a>
													<ul class="dropdown-menu">
									...
									<tbody v-cloak
										...
										<tr
											v-for="(listVehicleDTO,index) in vehicleInfoVO.listVehicleDTO">
											<td><input :id="listVehicleDTO.vehicleInfo.vehicle_id"
												:uni="listVehicleDTO.unit.unit_id" type="checkbox"
												name="flag"></td>
											...
											<td v-if="myRole==6 && listVehicleDTO.unit != undefined">
												{{listVehicleDTO.unit.unit_name}}</td>
											<td
												v-if="myRole!=6 && listVehicleDTO.vehicle_TeamDTO.team != undefined">
												{{listVehicleDTO.vehicle_TeamDTO.team.team_num}}</td>
											<td
												v-if="myRole!=6 && listVehicleDTO.vehicle_TeamDTO.team == undefined"></td>
											<td
												v-if="listVehicleDTO.driverDTO && listVehicleDTO.driverDTO.staffBasicInfo">
												{{listVehicleDTO.driverDTO.staffBasicInfo.staff_num}}</td>
											<td v-else></td>
											...
											<td>
												<div class="btn-group">
													...
													<ul class="dropdown-menu">
														<li><a
															@click="detailVehicle(listVehicleDTO.vehicleInfo.vehicle_id)"
														...
														<li v-if="myRole==4"><a
															@click="distVehicleDriver(listVehicleDTO.vehicleInfo.vehicle_id)"
															href="javascript:void(0);">分配车辆到驾驶员</a></li>
													</ul>
												</div>
											</td>
										</tr>
								...
								<div style="float: right;">
									<a v-if="myRole==6" href="#" @click="distVehicleTran"
										class="btn btn-info">单位调度</a> <a v-if="myRole==5" href="#"
										@click="distVehicleTeam" class="btn btn-info">车队调度</a>
					...
					<div class="modal-content">
						...
						<div class="mdoal-body">
							<table class="table table-hover">
								...
								<tbody>
									<tr v-for="driver in driverManagerDTO"
										...
										<td v-if="driver.driver != undefined">是</td>
										<td v-else>否</td>
										<td><a
											@click="selectVehicleDriver(driver.driver.driver_id)"
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr v-for="team in teamInfoList" :key="team.team.team_id">
										...
										<td><a @click="selectVehicleTeam(team.team.team_id)"
											class="btn btn-default" href="#">分配</a></td>
									</tr>
								</tbody>
							</table>
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr v-for="unit in unitList" :key="unit.unit_id"
										...
										<td><a @click="selectVehicleTran(unit.unit_id)"
											class="btn btn-default" href="#">分配</a></td>
									</tr>
								</tbody>
							</table>
