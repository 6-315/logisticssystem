...
<body>
						...
						<table class="table table-bordered" style="">
							<thead>
								<tr>
									...
									<th>快件品名</th>
									<th>快件备注</th>
									<th><select v-model="selectState"
										@change="getReservationByState" class="form-control"
										style="width: auto;">
								...
								<tr v-for="reser in reservationExpressList"
									...
									<td>
										<button @click="openDetail(reser)" class="btn btn-default">
											详情</button>
										<button
											@click="openDelete(reser.reservationInfo.reservation_id)"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/user/user-index.js"></script>
</body>
</html>