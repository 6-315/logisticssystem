...
<body>
	...
	<div id="userMyOrder" class="page" style="margin-top: 110px">
				...
				<div class="row">
					<div class="col-sm-2">
						<ul class="nav nav-pills nav-stacked" id="ul_status">
							<li role="presentation" :class="{active : active1}"><a
								@click="selectStateExpressInfo('')" href="javascript:void(0)">
									全部 </a></li>
							<li role="presentation" :class="{active : active2}"><a
								@click="selectStateExpressInfo('待揽件')" href="javascript:void(0)">
									待揽件 </a></li>
							<li role="presentation" :class="{active : active3}"><a
								@click="selectStateExpressInfo('已揽件')" href="javascript:void(0)">
									已揽件 </a></li>
							<li role="presentation" :class="{active : active4}"><a
								@click="selectStateExpressInfo('在途中')" href="javascript:void(0)">
									在途中 </a></li>
							<li role="presentation" :class="{active : active5}"><a
								@click="selectStateExpressInfo('待派送')" href="javascript:void(0)">
									待派送 </a></li>
							<li role="presentation" :class="{active : active6}"><a
								@click="selectStateExpressInfo('派送中')" href="javascript:void(0)">
									派送中 </a></li>
							<li role="presentation" :class="{active : active7}"><a
								@click="selectStateExpressInfo('已签收')" href="javascript:void(0)">
									已签收 </a></li>
						</ul>
					</div>
					<div class="col-sm-10 b-left">
							...
							<form class="form-inline">
								<div class="form-group" style="float: left;">
									<div class="input-group">
										...
										<input v-model="search" @input="selectKuaiDi" maxlength="20"
						...
						<div class="table-responsive">
							<table class="table table-hover m_top_10">
								...
								<tbody
									v-if="expressinfoAndExpressVO.listExpressinfoAndExpressDTO == undefined">
								...
								<tbody v-cloak
									...
									<tr
										v-for="myOrder in expressinfoAndExpressVO.listExpressinfoAndExpressDTO">
							...
							<div class="pagePosition">
								<ul v-cloak class="pagination">
									...
									<li :class="{disabled:nextDisabled}"><a
										:disabled="nextDisabled" href="#"> 下一页 <%--<span aria-hidden="true">&raquo;</span>--%>
									</a></li>
									<li><a href="#">尾页</a></li>
								</ul>
							</div>
		...
		<!-- 模态框（Modal） -->
		<div class="modal fade" id="expressDetail" tabindex="-1" role="dialog"
	...
	<script
		src="${pageContext.request.contextPath}/js/user/user-myorder.js"></script>
</body>
</html>