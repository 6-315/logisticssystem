...
<body>
	...
	<div id="userinfo" class="page" style="margin-top: 110px">
					...
					<div class="col-sm-10 b-left">
						...
						<form class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input readonly="readonly" v-model="userinfo_username"
										title="nickname" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">昵称</label>
								<div class="col-sm-4">
									<input v-model="userinfo_nickname" title="nickname"
										class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<label class="radio-inline"> <input value="男"
										name="userinfo_sex" type="radio" v-model="userinfo_sex">
										男
									</label> <label class="radio-inline"> <input value="女"
										name="userinfo_sex" type="radio" v-model="userinfo_sex">
										女
									</label>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input v-model="userinfo_email" value="" title="email"
										class="form-control" placeholder="请输入邮箱">
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-2  col-sm-4">
									<input @click="confirmUserInfo" value="修改"
		...
		<!-- 模态框（Modal） -->
		<div class="modal fade" id="updateUserInfo" tabindex="-1"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModal">更改用户信息</h4>
					</div>
					<div class="modal-body">更改后不可还原，点击确定后更改</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/user/user-userinfo.js"></script>
</body>
</html>