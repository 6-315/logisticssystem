...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/plugins/iZimodal/iziModal.min.css">
<link rel="stylesheet"
...
<body>
				...
				<div class="row">
					<div class="col-sm-2 hidden-xs">
						...
						<ul class="nav nav-pills nav-stacked">
							...
							<li><a
								href="${pageContext.request.contextPath}/userinfo/userinfo_pageUserAddress">地址管理</a></li>
							<li class="active"><a
					...
					<div class="col-sm-10 b-left m-height-300">
						...
						<div class="form-horizontal fv-form fv-form-bootstrap"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input @change="confirmOldPassword" v-model="view_oldpass"
										maxlength="25" value="" title="旧密码" class="form-control"
										placeholder="请输入旧密码" type="password"> <small
										:style="[oldEnity ? bl : no]" class="help-block">请输入旧密码
									</small> </small>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input v-model="newPass" maxlength="25" value="" title="新密码"
										...
										type="password"> <small style="display: none;"
										class="help-block" data-fv-validator="notEmpty"
										data-fv-for="newpass" data-fv-result="NOT_VALIDATED">请输入新密码
									</small> <small style="display: none;" class="help-block"
										data-fv-validator="regexp" data-fv-for="newpass"
										data-fv-result="NOT_VALIDATED">密码只能包含大小写字母，数字，长度8-25位
									</small> <small style="display: none;" class="help-block"
										data-fv-validator="identical" data-fv-for="newpass"
										data-fv-result="NOT_VALIDATED">两次密码输入不一致 </small> <small
										style="display: none;" class="help-block"
										data-fv-validator="stringLength" data-fv-for="newpass"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input @change="confirmNewPass" v-model="newConfirmPass"
										maxlength="25" required="required" name="repnewpass" value=""
										title="确认新密码" class="form-control" placeholder="请再次输入新密码"
										type="password"> <small :style="[newEnity ? bl : no]"
										class="help-block">请再次输入新密码 </small> <small
										:style="[newError ? bl : no]" class="help-block">两次密码输入不一致
									</small> <small style="display: none;" class="help-block"
										data-fv-validator="stringLength" data-fv-for="repnewpass"
										data-fv-result="NOT_VALIDATED">Please enter a value
										with valid length </small>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-4">
									<input @click="updatePassword" :disabled="disabled" value="提交"
										class="btn btn-primary btn-block m_top_20" type="button">
								</div>
							</div>
						</div>
					</div>
	...
	<script
		src="${pageContext.request.contextPath}/js/user/user-updatepassword.js"></script>
