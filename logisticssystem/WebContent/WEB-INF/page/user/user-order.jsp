                    ...
                    <div class="yto-item">
                        ...
                        <div class="form-group form-material">
                            ...
                            <div class="dropdown yto-city">
                                <input v-on:change="getDistributionByPosition"
                                       v-model="view_express.expressinfo_senderaddress"
                                       id="sendRegion" data-regionid="sendRegionId"
                        ...
                        <div class="form-group form-material">
                            <label class="control-label">配送点</label> <input
                                v-model="reservationInfo.reservation_unit"
                                name="sendReservation" class="form-control"
                                placeholder="请选择配送点" value="" id="sendReservation" type="text">
                            <ul class="list-value list-value-appreciation"
                                style="display: none;">
                                <li v-for="(item,index) of distributionList" :key="item.unit_id">
                                    <button class="btn btn-default btn-sm"
                                            type="button">{{item.unit_detailaddress}}
                                    </button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="form-group form-material">
                            <label class="control-label">手机</label> <input
                                ...
                                name="sendMobile" class="form-control" placeholder="手机或电话必填一项"
                ...
                <div class="col-sm-4">
                    <div class="yto-item">
                        ...
                        <div class="form-group form-material">
                            <label class="control-label">省/市/区</label>
                            <div class="dropdown yto-city">
                                <input v-model="view_express.expressinfo_addresseeaddress"
                                       id="receiveRegion" data-regionid="receiveRegionId"
                                       class="form-control" placeholder="请输入省市区"
                                       data-fv-field="sendRegion" type="text">
                            </div>
                        </div>
                    ...
                    <div class="yto-item" style="min-height: 460px">
                        ...
                        <div class="form-group form-material" id="limit">
                            <label class="control-label">增值服务</label> <input
                                ...
                                class="form-control support-input" maxlength="100"
                                placeholder="请选择增值服务" type="text">
                        </div>
                        <div class="form-group form-material">
